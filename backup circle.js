...
.deg45 {
  transform: rotate(45deg) translate(30rem) rotate(-45deg);
}
...
.deg135 {
  transform: rotate(135deg) translate(30rem) rotate(-135deg);
}
.deg180 {
  transform: translate(-30rem);
}
.deg225 {
  transform: rotate(225deg) translate(30rem) rotate(-225deg);
}
...
.deg315 {
  transform: rotate(315deg) translate(30rem) rotate(-315deg);
}
